...
#ifndef CS_VISION_ALGO_ALGOTENSORFLOWPERSONDETECTOR_H
#define CS_VISION_ALGO_ALGOTENSORFLOWPERSONDETECTOR_H
#include "AlgoBase.h"
...
namespace ninebot_algo {
    namespace ninebot_tensorflow{
        ...
        class AlgoTensorflowPersonDetector : public AlgoBase {
        public:
            AlgoTensorflowPersonDetector(RawData *rawInterface, int run_sleep_ms, bool is_render);

            ~AlgoTensorflowPersonDetector();
        ...
        private:
            ...
            void draw_boxes(std::vector<tensorflow::Tensor>& output_vector, cv::Mat& input_image);
...
#endif //CS_VISION_ALGO_ALGOTENSORFLOWPERSONDETECTOR_H
